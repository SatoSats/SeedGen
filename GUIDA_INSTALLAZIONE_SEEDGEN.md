...
- seedgen-v1.0.0-linux-x86_64.tar.gz
- seedgen-v1.0.0-linux-x86_64.tar.gz.asc
- seedgen-v1.0.0-linux-x86_64.tar.gz.sha256
...
sha256sum -c seedgen-v1.0.0-linux-x86_64.tar.gz.sha256

(Premi Invio)

Come risultato corretto deve dare:

✅ seedgen-v1.0.0-linux-x86_64.tar.gz: OK
...
gpg --verify seedgen-v1.0.0-linux-x86_64.tar.gz.asc seedgen-v1.0.0-linux-x86_64.tar.gz
